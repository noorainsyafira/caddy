                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label for="">IC</label>
                                    <input type="text" name="ic" value="{{ old('ic') }}" class="form-control">
                                    @error('ic')
                                        <div class="text-danger">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select name="nationality" class="form-control">
                                            ...
                                            <option value="Malaysian" @if(old('nationality') == 'Malaysian') selected @endif>Malaysian</option>
                                            <option value="Non-Malaysian" @if(old('nationality') == 'Non-Malaysian') selected @endif>Non-Malaysian</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
